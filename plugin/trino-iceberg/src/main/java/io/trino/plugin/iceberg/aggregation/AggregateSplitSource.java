        ...
        implements ConnectorSplitSource
{
    ...
    public CompletableFuture<ConnectorSplitBatch> getNextBatch(int maxSize)
    {
        ...
        boolean isInitialTaskRead = false;
        FileScanTask firstScanTask = null;
        ...
        while (fileScanTaskIterator.hasNext()) {
            ...
            if (!isInitialTaskRead) {
                firstScanTask = scanTask;
                isInitialTaskRead = true;
            }
        ...
        if (firstScanTask != null && recordCount >= 0) {
            AggregateIcebergSplit icebergSplit = toIcebergSplit(firstScanTask, recordCount);
    ...
    private AggregateIcebergSplit toIcebergSplit(FileScanTask task, long totalCount)
    {
